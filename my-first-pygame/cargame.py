...
lawn = pygame.image.load(os.path.join("images", "lawn.jpg")).convert()
lawn_x = 0
lawn_y = 0
lawn = pygame.transform.scale(lawn, (1920, 1000))
screen.blit(lawn, (lawn_x, lawn_y))

road = pygame.image.load(os.path.join("images", "road.jpg")).convert()
road_x = 350
road_y = 0
...
car2 = pygame.image.load(os.path.join("images", "car2.png"))
